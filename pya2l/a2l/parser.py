...
from pya2l.a2l.exception import A2lFormatException
...
class A2lParser(object):
    ...
    def p_dependent_characteristic(p):
        ...
        p[0] = DEPENDENT_CHARACTERISTIC(*p[3:5])
